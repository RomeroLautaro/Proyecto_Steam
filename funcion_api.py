...
# Datos a usar
df_reviews = pd.read_csv('D:\escritorio\Proyecto\datos\df_reviews_unido.csv')
df_gastos_items = pd.read_csv('D:\escritorio\Proyecto\datos\df_gastos_items_unido.csv')
df_genre_ranking = pd.read_csv('D:\escritorio\Proyecto\datos\df_genre_ranking_unido.csv')
df_playtime_forever = pd.read_csv('D:\escritorio\Proyecto\datos\df_playtime_forever_unido.csv')
df_items_developer = pd.read_csv('D:\escritorio\Proyecto\datos\df_items_developer_unido.csv')
piv_norm = pd.read_parquet('D:\escritorio\Proyecto\datos\piv_norm.parquet')
item_sim_df = pd.read_parquet('D:\escritorio\Proyecto\datos\item_sim_df.parquet')
user_sim_df = pd.read_parquet('D:\\escritorio\\Proyecto\\datos\\user_sim_df.parquet')
